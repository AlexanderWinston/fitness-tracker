...
const {getRoutineActivityById, destroyRoutineActivity, getRoutineById, updateRoutineActivity} = require ("../db")

// PATCH /api/routine_activities/:routineActivityId
routines_activitiesRouter.patch("/:routineActivityId", requireUser, async (req, res, next)=>{
